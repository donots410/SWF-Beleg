 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ProgramImpl#getClause <em>Clause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
  ...
  public EList<Clause> getClause()
  {
    if (clause == null)
    {
      clause = new EObjectContainmentEList<Clause>(Clause.class, this, MyDslPackage.PROGRAM__CLAUSE);
    }
    return clause;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.PROGRAM__CLAUSE:
